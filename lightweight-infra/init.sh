...
services=("cluster-operators" "data-loader" "esservice" "event-executor" "llm-data-loader" "llm-platform-api" "llm-platform-esservice" "llm-platform-operators" "llm-platform-status-updater" "llm-platform-ui" "python-operator-batch-processor" "python-operator" "status-updater" "umap-operators") 
